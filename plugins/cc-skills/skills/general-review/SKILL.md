---
name: general-review
description: Perform comprehensive code review checking for logging, error handling, TypeScript, production readiness, React/Hooks, performance, security, and architecture.
---
