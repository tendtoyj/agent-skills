---
name: peer-review
description: Critically evaluate findings from a peer code review, verifying each finding against actual code and producing a prioritized action plan for confirmed issues.
---
